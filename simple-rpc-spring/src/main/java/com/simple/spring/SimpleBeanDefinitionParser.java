...
public class SimpleBeanDefinitionParser implements org.springframework.beans.factory.xml.BeanDefinitionParser {

    private static final Logger logger = LoggerFactory.getLogger(SimpleBeanDefinitionParser.class);
    ...
    public SimpleBeanDefinitionParser(Class<?> beanClass, boolean required) {
